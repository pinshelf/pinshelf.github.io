...
<div class="p-1.5 my-2 h-24 dark:hover:bg-zinc-800 rounded-md flex flex-row items-center space-x-1">
    <!-- Icon -->
    <div class="w-7 h-full flex flex-row items-start justify-center">
        <img
    ...
    <div class="w-full h-full flex flex-row">
        ...
        <div class="w-full h-full flex flex-col justify-between">
            ...
            <div>
                ...
                <p class="text-[12px] font-mono line-clamp-1 text-zinc-500 dark:text-zinc-400 select-none">{bookmark.url}</p>
            </div>
